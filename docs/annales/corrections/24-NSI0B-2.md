...
[:material-arrow-left:](24-NSI0B-1.md){ .md-button .nav-button }
[:fontawesome-solid-file-pdf: &nbsp; Énoncé](../exercices/24-NSI0B-2.pdf){ .md-button }
[:fontawesome-solid-file-pdf: &nbsp; Sujet](../sujets/24-NSI0B.pdf){ .md-button }
[:material-arrow-right:](24-NSI0B-3.md){ .md-button .nav-button }
</div>
<!--NAVIGATION_END-->
