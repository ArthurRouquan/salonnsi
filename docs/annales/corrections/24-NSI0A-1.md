...
8.  * Fibre : $10^8 / 10^9 = 0.1$
    * Fast-Ethernet : $10^8 / (100 \cdot 10^6) = 1$
    * Ethernet : $10^8 / (10 \cdot 10^6) = 10$

9. Soit $x$ le coût de la liaison R2–R6. Lorsqu’un paquet part de R1 vers N2 en passant par l’interface `eth2`, il peut emprunter l’une des deux routes suivantes :
...
11. ![](assets/24-NSI0A-1-Q11.svg){ .center-img }
