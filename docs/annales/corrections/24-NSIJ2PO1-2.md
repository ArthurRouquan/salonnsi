...
[:material-arrow-left:](24-NSIJ2PO1-1.md){ .md-button .nav-button }
[:fontawesome-solid-file-pdf: &nbsp; Énoncé](../exercices/24-NSIJ2PO1-2.pdf){ .md-button }
[:fontawesome-solid-file-pdf: &nbsp; Sujet](../sujets/24-NSIJ2PO1.pdf){ .md-button }
[:material-arrow-right:](24-NSIJ2PO1-3.md){ .md-button .nav-button }
</div>
<!--NAVIGATION_END-->
