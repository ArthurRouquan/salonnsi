...
[:material-arrow-left:](25-NSIPE2-1.md){ .md-button .nav-button }
[:fontawesome-solid-file-pdf: &nbsp; Énoncé](../exercices/25-NSIPE2-2.pdf){ .md-button }
[:fontawesome-solid-file-pdf: &nbsp; Sujet](../sujets/25-NSIPE2.pdf){ .md-button }
[:material-arrow-right:](25-NSIPE2-3.md){ .md-button .nav-button }
</div>
<!--NAVIGATION_END-->
